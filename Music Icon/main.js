...
//Grabbed template element from ID templateHB
const templateElement = document.getElementById('templateHB');

//assigned innerHTML of the template element to variable
const templateSource = templateElement.innerHTML;

//compiled innerHTML of template with Handlebar compiler to a function
const template = Handlebars.compile(templateSource);

//use the function to pass in the context to compile context object
// assigned the return value to a new variable named compiled
const compiledHtml = template(context);

//rendering the compiled HTML in the browser
